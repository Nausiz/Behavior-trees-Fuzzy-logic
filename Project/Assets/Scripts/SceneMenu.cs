...
public class SceneMenu : MonoBehaviour
{
    ...
    [SerializeField]
    private TextMeshProUGUI textWinsNPC1;
    [SerializeField]
    private TextMeshProUGUI textPowerUpsNPC1;
    [SerializeField]
    private TextMeshProUGUI textHealsNPC1;

    [SerializeField]
    private TextMeshProUGUI textWinsNPC2;
    [SerializeField]
    private TextMeshProUGUI textPowerUpsNPC2;
    [SerializeField]
    private TextMeshProUGUI textHealsNPC2;

    [SerializeField]
    private PlayerMovementTest npc1;
    [SerializeField]
    private PlayerMovementTest npc2;
